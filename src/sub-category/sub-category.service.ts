...
//     return await this.subcategoryModel.find(query).exec();
//   }
...
//   // Find all subcategories under a specific category
//   async findByCategoryId(categoryId: Types.ObjectId): Promise<Subcategory[]> {
//     return await this.subcategoryModel.find({ categoryId }).exec();
//   }
// }
